...
class _NewsState extends State<News> {
  ...
  _loadData() async {
    ...
    setState(() {
      ...
      PageController _controller = PageController(initialPage: _posts.length - 1);
      currentPage = _posts.length - 1.0;
      _controller.addListener(() {
        setState(() {
          print("Current page b4 is : " + currentPage.toString());
          print("_controller page b4 is : " + _controller.page.toString());
          currentPage = _controller.page;
          print("Current page after is : " + currentPage.toString());
          print("_controller page after is : " + _controller.page.toString());
        });
      });
